window.angular.module('ngff.services.nfl', [])
  .factory('NFL', function() {
    //Creates an object containing all the relevant information about the various NFL teams
    var NFL = {};

    //Set all the data for the various NFL teams in an array of objects that can be easily accessed
    NFL.teams = [
